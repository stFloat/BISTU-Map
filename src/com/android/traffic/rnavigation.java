...
public class rnavigation extends Activity implements
OnGetGeoCoderResultListener{
	 ...
	 * @param view
	 */
	public void startridingNavi(View view) {
		// 获取编辑框中的起始城市和地址；
	...
	public void onGetGeoCodeResult(GeoCodeResult result) {
		...
		if (isFirst == true) {
			...
			Log.i("rnavigation", "结束纬度：" + end_latitude + "结束经度："
					+ end_longitude);
			isFirst = true;

			Log.i("rnavigation", "开始纬度：" + start_latitude + ";开始经度："
